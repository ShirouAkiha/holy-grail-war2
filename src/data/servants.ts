    ...
    skills: [
      {
        ...
        cooldown: 6,
        description: 'Grants self Invincibility for 2 turns, increases Critical Star Gather Rate by +50%, and increases own Critical Damage by +30% for 3 turns.',
        effectType: 'invincible',
        duration: 2,
        value: 100,
        icon: '⚡',
