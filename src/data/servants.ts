...
export const SERVANT_DATABASE: ServantTemplate[] = [
    ...
    skills: [
      {
        ...
        name: 'Mana Burst A',
        cooldown: 5,
        description: 'Increases own Buster Card effectiveness by 50% for 1 turn.',
        effectType: 'buff_atk',
        value: 50,
        duration: 1,
        icon: '⚔️'
      ...
      },
      {
        ...
        cooldown: 6,
        description: 'Charges own NP gauge by 30% and gains 15 Critical Stars.',
    ...
    skills: [
      {
        ...
        name: 'Collector EX',
        cooldown: 5,
        description: 'Greatly increases Critical Star absorption by 600% and charges 30% NP.',
        effectType: 'np_charge',
        value: 30,
        duration: 3,
        icon: '💎'
      },
      {
        ...
        name: 'Golden Rule A',
        cooldown: 6,
        description: 'Increases own NP generation rate by 50% for 3 turns.',
        effectType: 'buff_atk',
        value: 50,
        duration: 3,
        icon: '🪙'
      },
      {
        ...
        cooldown: 5,
        description: 'Gains 20 Critical Stars and increases Critical Damage by 40% for 3 turns.',
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        cooldown: 6,
        description: 'Increases one ally Quick Card effectiveness by 50% for 1 turn.',
        effectType: 'buff_atk',
        value: 50,
        duration: 1,
        icon: '⚡'
      },
      {
        ...
        name: 'God Slayer A+',
        cooldown: 5,
        description: 'Grants self Divine Killer and Undead Killer bonus for 1 turn.',
        effectType: 'buff_atk',
        value: 100,
        duration: 1,
        icon: '🔱'
    ...
    noblePhantasm: {
      ...
      target: 'single',
      multiplier: 1200,
      overchargeEffect: 'Stun foe for 1 turn + 100% Instant-Death chance'
    },
    ...
    skills: [
      {
        ...
        name: 'Revelation A',
        cooldown: 6,
        description: 'Gains 9 Critical Stars per turn for 3 turns through divine intuition.',
        effectType: 'crit_stars',
        value: 9,
        duration: 3,
        icon: '🕊️'
      },
      {
        ...
        cooldown: 5,
        description: 'Greatly reduces enemy Noble Phantasm strength by 30% for 1 turn.',
        effectType: 'buff_def',
        value: 30,
        duration: 1,
        icon: '📜'
      },
      {
        ...
        name: 'Divine Grace A+',
        cooldown: 5,
        description: 'Heals self and allies for 3000 HP and clears debuffs.',
        effectType: 'heal',
        value: 3000,
        duration: 1,
        icon: '💖'
  ...
  // 4-Star SR Servants
  {
    ...
    skills: [
      ...
      },
      {
        ...
        name: 'Hawkeye B+',
        cooldown: 6,
        description: 'Increases Critical Star generation and Critical Damage by 100% for 3 turns.',
        effectType: 'crit_stars',
        value: 100,
        duration: 3,
        icon: '🎯'
      },
      {
        ...
        cooldown: 5,
        description: 'Increases own Buster, Arts, and Quick card effectiveness by 40% for 1 turn.',
        effectType: 'buff_atk',
        value: 40,
        duration: 1,
        icon: '⚔️'
    ...
    skills: [
      {
        ...
        name: 'Valor A+',
        cooldown: 5,
        description: 'Increases own Attack by 31% for 3 turns and grants mental debuff immunity.',
        effectType: 'buff_atk',
        value: 31,
        duration: 3,
        icon: '🦁'
      ...
      },
      {
        ...
        cooldown: 7,
        description: 'Grants self Guts (Revive with 2500 HP on lethal damage).',
        effectType: 'heal',
        value: 2500,
        duration: 5,
        icon: '🩸'
    ...
    skills: [
      {
        ...
        cooldown: 5,
        description: 'Grants self 3 stacks of Evade and increases DEF by 16% for 3 turns.',
        effectType: 'evade',
        value: 100,
        duration: 3,
        icon: '🛡️'
      },
      {
        ...
        name: 'Guts B',
        cooldown: 7,
        description: 'Grants self Guts status (Revive with 1500 HP).',
        effectType: 'heal',
        value: 1500,
        duration: 5,
        icon: '🩸'
      },
      {
        ...
        name: 'Disengage C',
        cooldown: 5,
        description: 'Removes own debuffs and recovers 1500 HP.',
        effectType: 'heal',
        value: 1500,
        duration: 1,
        icon: '💨'
  ...
  // Custom Lore & Server Meme Servants
  {
    ...
    skills: [
      {
        ...
        cooldown: 5,
        description: 'Increases own Attack by 45% and grants Invincible pierce for 1 turn.',
        effectType: 'buff_atk',
        value: 45,
        duration: 1,
        icon: '💻'
      },
      {
        ...
        cooldown: 6,
        description: 'Clears all status debuffs and grants 30% NP Charge + 20 Stars.',
        effectType: 'np_charge',
        value: 30,
        duration: 1,
        icon: '🌿'
    ...
    noblePhantasm: {
      ...
      target: 'aoe',
      multiplier: 550,
      overchargeEffect: 'Stun all enemies (1 turn) + 30% DEF shred'
    },
    ...
    skills: [
      {
        ...
        cooldown: 5,
        description: 'Reduces enemy Speed & Crit Star drop by 50% for 2 turns.',
        effectType: 'buff_def',
        value: 50,
        duration: 2,
        icon: '⏳'
      },
      {
        ...
        cooldown: 6,
        description: 'Grants self 2 turns of Evade and generates 25 Crit Stars.',
        effectType: 'evade',
        value: 100,
        duration: 2,
        icon: '🗑️'
      },
      {
        ...
        cooldown: 5,
        description: 'Gains 35% Attack power and increases Quick performance by 30%.',
        effectType: 'buff_atk',
        value: 35,
        duration: 1,
        icon: '🔔'
  ...
  },
  {
    ...
    skills: [
      {
        ...
        cooldown: 5,
        description: 'Increases Buster card damage by 40% and Crit Rate by 50% for 2 turns.',
        effectType: 'buff_atk',
        value: 40,
        duration: 2,
        icon: '☕'
      },
      {
        ...
        cooldown: 6,
        description: 'Heals 2500 HP and grants Guts (Revive with 1000 HP).',
        effectType: 'heal',
        value: 2500,
        duration: 3,
        icon: '⚡'
      },
      {
        ...
        cooldown: 5,
        description: 'Increases Attack by 50% for 1 turn (Self-inflicts minor defense drop).',
        effectType: 'buff_atk',
        value: 50,
        duration: 1,
        icon: '🌪️'
    ...
    noblePhantasm: {
      ...
      target: 'single',
      multiplier: 800,
      overchargeEffect: 'Gain 50 Critical Stars + 20% ATK buff'
    },
...
export const servants = SERVANT_DATABASE;
