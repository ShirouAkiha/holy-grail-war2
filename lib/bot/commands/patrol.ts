 ...
 * Description: Patrol Fuyuki sectors to gather intel and scout rivals
 * Library: discord.js v14
 */

export const patrolCommandCode = `import { SlashCommandBuilder, ChatInputCommandInteraction, EmbedBuilder } from 'discord.js';
