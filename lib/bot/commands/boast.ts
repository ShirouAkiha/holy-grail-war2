/**
 * Slash Command: /boast
 * Description: Publicly announce Servant parameters to the server (permanent exposure)
 * Library: discord.js v14
 */

export const boastCommandCode = `import { SlashCommandBuilder, ChatInputCommandInteraction, EmbedBuilder } from 'discord.js';
