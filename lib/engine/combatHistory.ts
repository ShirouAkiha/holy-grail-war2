  ...
  },
  {
    ...
    turns: [
      ...
      },
      {
        ...
        targetId: 'p2_gilles_caster',
        targetName: 'Gilles de Rais',
        actionSummary: '🕊️ NOBLE PHANTASM UNLEASHED! Jeanne planted the holy standard of Orléans, unfurling Luminosité Eternelle: bestowed party Invincibility (1T), +30% DEF (3T), removed all debuffs, and activated HP recovery!',
        cardChainType: 'Arts Chain',
