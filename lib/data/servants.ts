...
export const SERVANT_DATABASE: ServantTemplate[] = [
    ...
    skills: [
      {
        ...
        cooldown: 5,
        description: 'Increases own Attack by 20% and grants Invincible pierce for 1 turn.',
        effectType: 'buff_atk',
        value: 20,
        duration: 1,
        icon: '💻'
      },
      {
        ...
        cooldown: 6,
        description: 'Clears all status debuffs and grants 20% NP Charge + 12 Stars.',
        effectType: 'np_charge',
        value: 20,
        duration: 1,
        icon: '🌿'
    ...
    skills: [
      {
        ...
        cooldown: 5,
        description: 'Reduces enemy Speed & increases own DEF by 25% for 2 turns.',
        effectType: 'buff_def',
        value: 25,
        duration: 2,
        icon: '⏳'
      },
      {
        ...
        cooldown: 6,
        description: 'Grants self 1 turn of Evade and generates 15 Crit Stars.',
        effectType: 'evade',
        value: 100,
        duration: 1,
        icon: '🗑️'
      },
      {
        ...
        cooldown: 5,
        description: 'Gains 20% Attack power and increases Quick performance by 20%.',
        effectType: 'buff_atk',
        value: 20,
        duration: 1,
        icon: '🔔'
  ...
  },
  {
    ...
    skills: [
      {
        ...
        cooldown: 5,
        description: 'Increases Buster card damage by 20% and Crit Rate by 20% for 2 turns.',
        effectType: 'buff_atk',
        value: 20,
        duration: 2,
        icon: '☕'
      },
      {
        ...
        cooldown: 6,
        description: 'Heals 2,500 HP and grants Guts (Revive with 1,500 HP).',
        effectType: 'heal',
        value: 2500,
        duration: 3,
        icon: '⚡'
      },
      {
        ...
        cooldown: 5,
        description: 'Increases Attack by 20% for 1 turn.',
        effectType: 'buff_atk',
        value: 20,
        duration: 1,
        icon: '🌪️'
    ...
    noblePhantasm: {
      ...
      target: 'single',
      multiplier: 480,
      overchargeEffect: 'Gain 25 Critical Stars + 15% ATK buff'
    },
