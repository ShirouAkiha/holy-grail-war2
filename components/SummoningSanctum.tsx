...
export default function SummoningSanctum({
  ...
  return (
    <div className="space-y-6">
      ...
      {activeSubTab === 'ritual' && (
        <div className="space-y-6">
          {/* Visual Novel Summon Dialogue Cut-In Frame & Canvas Card (Upon Summon or Active Contract) */}
          {(summonSuccessServant || activeContract) && (
            <div className="space-y-4">
              {/* Canvas Card Renderer */}
              <div className="p-2 bg-[#080d1a] rounded-xl border border-[#d4af37]/40 shadow-[0_0_25px_rgba(212,175,55,0.2)]">
                    ...
                    results: summonResults || [
                      {
                        ...
                        rarity: (summonSuccessServant || activeContract?.template)?.rarity || 5,
                        isNew: true,
                        isRateUp: true
                      }
                    ]
